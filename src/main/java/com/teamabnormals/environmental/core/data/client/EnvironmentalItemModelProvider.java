...
public class EnvironmentalItemModelProvider extends BlueprintItemModelProvider {
	...
	protected void registerModels() {
		...
		this.spawnEggItem(SLABFISH_SPAWN_EGG, DUCK_SPAWN_EGG, DEER_SPAWN_EGG, REINDEER_SPAWN_EGG, YAK_SPAWN_EGG, KOI_SPAWN_EGG, TAPIR_SPAWN_EGG, ZEBRA_SPAWN_EGG, PINECONE_GOLEM_SPAWN_EGG);
